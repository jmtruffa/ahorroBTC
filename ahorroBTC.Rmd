...
Le cambiamos el nombre para que la columna se llame Fecha.
```{r}
...
Listo. ya tenemos la serie de precios de Bitcoin.
...
Cómo está en la librería dplyr, primero la cargamos.
